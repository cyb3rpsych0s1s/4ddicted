...
public class English extends LocalizationPackage {
    protected func DefineTexts() -> Void {
        ...
        this.Text("Mod-Addicted-Consumable-Addiquit-Caution",           "\n<Rich color=\"MainColors.ActiveYellow\" style=\"Semi-Bold\">Mise en garde</>\nSubstitutes, while initially helpful in severing withdrawal symptoms, can quickly lead to exhaustion. Please use responsibly and seek medical advice if depression develops");
        // Drug Pump
