...
public class French extends LocalizationPackage {
    protected func DefineTexts() -> Void {
        ...
        this.Text("Mod-Addicted-Consumable-Addiquit-Caution",           "\n<Rich color=\"MainColors.ActiveYellow\" style=\"Semi-Bold\">Mise en garde</>\nLes substituts, bien qu'initialement prévus pour accompagner le sevrage des patients souffrants d'accoutumance, peuvent rapidement accroître leur fatigue. Veuillez à être accompagné par votre médecin traitant, et n'hésitez pas à consulter en cas de dépression.");
        // Drug Pump
